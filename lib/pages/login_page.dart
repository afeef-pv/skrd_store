...
class LoginPageState extends State<LoginPage> {
  ...
  _registerUser() async {
    ...
    var body = {"phone": _mobile, "password": _password};
    http.Response response = await http.post(
        hostUrl + '/api/v0/users/auth/login',
  ...
  void _showErrorSnack(String error) {
    ...
    // throw Exception('Error loging in $error');
  }

  void _showSuccessSnack() {
    final snackbar = SnackBar(
        content: Text('User $_mobile successfully loged in!',
